...
import { ActivityLog, CategoryKey, EconomicsContent, FortuneContent, HealthContent, LanguageContent, QuizContent } from '../types';
    ...
    switch (categoryKey) {
        ...
        case 'language':
            ...
            return <div className="space-y-2 text-center">
                 <p className="text-sm text-gray-500">{lang.context}</p>
                 <p className="font-bold text-xl">"{lang.phrase}"</p>
